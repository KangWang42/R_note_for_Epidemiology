...
(function () {
  ...
  function updateButton(dark) {
    ...
    var label = dark ? '切换到日间模式' : '切换到夜间模式';
  ...
  function createButton() {
    ...
    var mount = document.querySelector('.quarto-navbar-tools') || document.body;
    mount.appendChild(button);
    updateButton(document.documentElement.hasAttribute('data-theme'));
  }
